    ...
    <div className={styles.overlay}>
      <div className={styles.principalContainerRegister}>
        <div className={styles.containerDataRegister}>
          ...
          <form onSubmit={handleSubmit} className={styles.containerInputRegister}>
            ...
            <div className={styles.inputContainer}>
              ...
              />
              {errors.contrasenia && <p className={styles.error}>{errors.contrasenia}</p>}
            </div>
            <div className={styles.inputContainer}>
              <input
                onChange={handleChange}
            ...
            <div className={styles.containerButtonRegister}>
              <button className={styles.submitbtn} type="submit" disabled={!isFormValid()}>Registrarse</button>
              <button type="button" onClick={onCloseRegister}>Cancelar</button>
            </div>
          </form>
        </div>
      </div>
